...
document.addEventListener('DOMContenLoaded', function () {
  ...
  window.store = store;
  window.receiveSearchGiphys = Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_4__["receiveSearchGiphys"])();
...
var congifureStore = function congifureStore() {
...
/* harmony default export */ __webpack_exports__["default"] = (congifureStore);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=HqGoCNqPpVyzilioQYMBk1zc1NDLBGn5&limit=2")
  });
};
